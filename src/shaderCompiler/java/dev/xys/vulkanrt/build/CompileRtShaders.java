...
public final class CompileRtShaders {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            for (String name : new String[]{"primary.rgen","primary.rmiss","primary.rchit","chunks.rgen","chunks.rmiss","chunks.shadow.rmiss","chunks.rchit","chunks.rahit","chunks.shadow.rchit","chunks.shadow.rahit","overlay.comp","entity-local.comp"}) {
